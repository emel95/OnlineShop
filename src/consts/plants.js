const plants = [
    {
      ...
      price: 39.99,
      img: require('../assets/image/plant1.png'),
      about:
  ...
  
    {
      ...
      name: 'Dragon Plant',
      price: 29.99,
      img: require('../assets/image/plant2.png'),
      about:
    ...
    },
    {
      ...
      name: 'Ravenea Plant',
      price: 25.99,
      img: require('../assets/image/plant3.png'),
      about:
  ...
  
    {
      ...
      name: 'Potted Plant',
      price: 25.99,
      img: require('../assets/image/plant4.png'),
      about:
    ...
    },
    {
      ...
      name: 'Ravenea Plant',
      price: 50.99,
      img: require('../assets/image/plant5.png'),
      about:
        'Potted Plant Ravenea Plant one of the most popular and beautiful species that will produce clumpms. The storage of water often gives succulent plants a more swollen or fleshy appearance than other plants, a characteristic known as succulence.',
    },
    {
      ...
      name: 'Dragon Plant',
      price: 50.99,
      img: require('../assets/image/plant6.png'),
      about:
        'Potted Plant Ravenea Plant one of the most popular and beautiful species that will produce clumpms. The storage of water often gives succulent plants a more swollen or fleshy appearance than other plants, a characteristic known as succulence.',
    },
  ];
